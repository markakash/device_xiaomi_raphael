...
PRODUCT_COPY_FILES += \
    device/xiaomi/raphael/sec_config:$(TARGET_COPY_OUT_VENDOR)/etc/sec_config
...
PRODUCT_COPY_FILES += \
    ...
    device/xiaomi/raphael/media/media_profiles.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles.xml \

ifneq ($(TARGET_ENABLE_QC_AV_ENHANCEMENTS),true)
PRODUCT_COPY_FILES += \
    device/xiaomi/raphael/media/media_codecs.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs.xml \
    device/xiaomi/raphael/media/media_profiles.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml
endif
